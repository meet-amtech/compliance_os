...
class User(AbstractBaseUser, PermissionsMixin, BaseModel):
    ...
    """
    tenant = models.ForeignKey('tenants.Tenant', on_delete=models.CASCADE,null=True, blank=True, db_index=True, help_text=_("Placeholder for Multi-Tenancy"), related_name='users')
